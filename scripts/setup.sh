...
echo "Next steps:"
echo "1. Verify the install: python scripts/verify_installation.py"
echo "2. Download base model from Hugging Face (see README.md)"
echo "3. Download LoRA adapters: bash scripts/download_checkpoints.sh"
echo "4. Try inference:"
echo "     python generate_step.py \\"
echo "         --ckpt_path ./checkpoints/step-llm-llama3b-no_rag \\"
echo "         --caption   'A cylindrical bolt with a hexagonal head'"
echo ""
echo "To train from scratch instead:"
echo "5. Download dataset: bash scripts/download_abc_dataset.sh"
echo "6. Process dataset: bash scripts/process_dataset.sh"
echo ""
